        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" name="remember"
                    class="rounded bg-[#dedddd] border-[#dedddd] dark:bg-[#dedddd] dark:border-[#dedddd] text-gray-600 shadow-sm focus:ring-0 dark:focus:ring-0" />
        ...
        <div class="flex items-center justify-between mt-4 w-full">
            <div>
                @if (Route::has('password.request'))
                    <a class="underline text-sm text-[#696666] dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
