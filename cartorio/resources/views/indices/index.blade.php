...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch(`/protocolo/buscar-indices?${params.toString()}`)
                .then(response => {
                    if (!response.ok) {
                        return response.json().then(err => {
                            throw new Error(err.erro || 'Nenhum protocolo encontrado.');
                        });
                    }
                ...
                .then(paginatedData => {
                    ...
                    protocolos.forEach(protocolo => {
                        ...
                        const dataFormatada = new Date(protocolo.created_at).toLocaleDateString('pt-BR', {
                            timeZone: 'UTC'
                        });
        ...
        grupoSelect.addEventListener('change', function() {
            filtrarNaturezasPorGrupo(this.value);
        });
