    ...
    <form action="/endpoint" method="post">
        ...
        <div class="flex justify-center items-center w-full min-h-screen bg-gray-100">
            ...
            <div class="flex flex-wrap justify-start w-[92%] bg-white rounded-t-md p-4">
                ...
                <div class ="flex flex-wrap justify-start w-full rounded-t-md p-4">
                    <!-- Primeira coluna (1/8) -->
                ...
                <div class ="flex flex-wrap justify-start w-full rounded-t-md p-4">
                        <!-- Quarta coluna (4/8) -->
                        <div class="campo-formulario flex items-center ml-6 w-[200px]"> 
                            <div class="text-left">
                        ...
                        <div class="campo-formulario flex items-center ml-6"> 
                            <div class="text-left">
                                ...
                                <x-input-naoalteravel id="autenticacao_protocolo" name="autenticacao_protocolo" class="w-[200px] h-7.5 text-sm">
                                </x-input-naoalteravel>
                            </div>
                        </div>
                </div>
                    ...
                    <div class ="flex flex-wrap justify-start w-full rounded-t-md p-4">
                            ...
                            <div class="campo-formulario flex items-center ml-6"> 
                                <div class="text-left">
                                    ...
                                    <x-input-select id="id_forma_pagamento" name="id_forma_pagamento" class="w-[200px] h-8 text-sm" required>
                            ...
                            <div class="campo-formulario flex items-center"> 
                                <div class="text-left">
                                    ...
                                    <x-input-select id="id_banco" name="id_banco" class="w-[200px] h-8 text-sm" required>
                    ...
                    <div class ="flex flex-wrap justify-start w-full rounded-t-md p-4">
                            ...
                            <div class="campo-formulario flex items-center ml-6"> 
                                <div class="text-left">
                                    ...
                                    <x-text-input id="autenticacao_conta" name="autenticacao_conta" class="w-[200px] h-8 text-sm" required />
                                </div>
                            </div>
                            ...
                            <div class="campo-formulario flex items-center"> 
                                <div class="text-left">
                                    ...
                                    <x-text-input id="autenticacao_agencia" name="autenticacao_agencia" class="w-[200px] h-8 text-sm" required />
                                </div>
                            </div>
                            ...
                            <div class="campo-formulario flex items-center"> 
                                <div class="text-left">
                                    ...
                                    <x-text-input id="autenticacao_cheque" name="autenticacao_cheque" class="w-[200px] h-8 text-sm" required />
                                </div>
                            </div>
                    </div>
             </div>
