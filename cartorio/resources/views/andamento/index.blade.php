    ...
    <div class="max-w-[75%] mx-auto w-full px-4">
        <form id="andamento_form" action="{{ route('andamento.store') }}" method="post">
            ...
            <div class="flex justify-start w-[92%] h-10 mx-auto bg-[#9f9f9f] rounded-t-md space-x-4">
                <div class="text-left flex items-center ml-4 w-[180px]">
                    <x-input-label>Data/Hora</x-input-label>
                </div>
                <div class="text-left flex items-center w-[205px]">
                    <x-input-label>Tipo de Andamento</x-input-label>
                </div>
                <div class="text-left flex items-center w-[135px]">
                    <x-input-label>Valor</x-input-label>
                </div>
                <div class="text-left flex items-center w-[365px]">
                    <x-input-label>Observação</x-input-label>
                </div>
                <div class="text-left flex items-center w-[200px]">
